    ...
    if (payload.id) {
      const { data, error } = await adminClient
        ...
        .update({
          ...
          asset_type: payload.assetType ?? "file",
          url: payload.assetType === "color" ? null : payload.url ?? null,
          file_name: payload.assetType === "color" ? null : payload.fileName ?? null,
          content_type: payload.assetType === "color" ? null : payload.contentType ?? null,
          hex_color: payload.assetType === "color" ? payload.hexColor ?? null : null,
