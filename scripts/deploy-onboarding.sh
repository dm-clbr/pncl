...
supabase functions deploy submit-onboarding submit-onboarding-contract submit-portal-ica get-portal-ica-document get-portal-ica-status get-onboarding-status retry-onboarding-enrollment reveal-onboarding-credentials setup-portal-account resend-portal-confirmation get-referrer-info create-referral-invite list-referral-invites admin-update-comp-level admin-list-agents admin-get-hierarchy admin-create-user admin-update-role admin-update-referrer admin-resend-activation admin-get-user-profile admin-list-portal-todos admin-upsert-portal-todo admin-delete-portal-todo admin-reorder-portal-todos admin-get-portal-todo-completion admin-set-user-todo-completion list-portal-todos list-portal-carrier-credentials upsert-portal-carrier-credential admin-notify-suspended-gmail admin-list-gmail-verification-candidates admin-send-gmail-verification admin-backfill-google-recovery admin-reactivate-google-user admin-delete-user admin-list-onboarding-holds admin-release-onboarding-hold admin-retry-onboarding admin-create-enrollment-resume
